class InstallGenerator < Rails::Generators::Base
  ...
  def news
    if yes?('Would you like to install module News? (y/n)')
      ...
      insert_into_file 'config/initializers/rails_admin.rb', File.read('vendor/bms/initializers/_rails_admin_news.rb').force_encoding('UTF-8'), after: "RailsAdmin.config do |config|\n"
    end
  end
